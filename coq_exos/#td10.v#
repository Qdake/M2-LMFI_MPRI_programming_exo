...
Definition FalseBis := forall P, P.

Definition OrBis (P Q : Prop) :Prop :=
  forall R:Prop, (P -> R) -> (Q -> R) -> R.

Lemma or_euiqv P Q : P \/ Q <-> OrBis P Q.
Proof.
  split.
  - destruct 1.
    + unfold OrBis. intros R pr qr. apply pr. apply H.
    + intros R pr qr. apply qr, H.
  - intro H. unfold OrBis in H. apply H. (*!!!! ce usage de apply *)
    + now left.
    + now right.
Qed.
...
Proof.
  ...
  - intros H. unfold ExistsBis in H. apply H.
    intros w Hw.
    exists w. auto.
Qed.
